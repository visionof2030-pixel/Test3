...
/* ======= الهدف التربوي (مُحسَّن فقط في PDF) ======= */
.goal-section{
  background:#e8f5e9;
  border:2px solid #2e7d32;
  padding:12px;
  margin-bottom:10px;
  min-height:140px;        /* يتحمل 25 كلمة براحة */
  line-height:1.8;         /* قراءة مريحة */
}
...
<!-- 🔴 لم يتم تغيير أي شيء آخر في الملف -->
<!-- الكود الخاص بالـ HTML + JavaScript يبقى كما هو عندك تمامًا -->
